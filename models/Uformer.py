...
class Uformer(nn.Module):
    def __init__(self, args, img_size=256, in_chans=3, dd_in=3,
...
# model = Uformer(img_size=256, embed_dim=16, depths=depths,
#                             win_size=8, mlp_ratio=4., token_projection='linear', token_mlp='leff', modulator=True,
#                             shift_flag=False, args=args)
# model = model.cuda()
...
#                                 shift_flag=False,args=args)
#
#     flops, params = get_model_complexity_info(model_restoration, input_res=(3, 512, 512), as_strings=True,
